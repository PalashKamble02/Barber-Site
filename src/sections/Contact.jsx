...
<div data-aos='zoom-in' id='img-box' className=' w-full bg-cover bg-center h-[700px]' style={{backgroundImage:`url(${contactimg})`}}>
...
<input type="Email" placeholder='Enter Your Valid Email Address' className=' w-full p-3 text-black font-semibold' />
<textarea name="" id="" cols='30' rows='5' placeholder='Enter your message here ......' className='w-full p-3'></textarea>
<input type="submit" value='SUBMIT' className='bg-themeyellow hover:bg-[#92843b] cursor-pointer w-full font-semibold text-lg text-black p-3' />
