   ...
   <section id='about' className=' w-full md:px-20 px-10 md:py-20 py-10 flex flex-col md:flex-row justify-center items-center gap-20 bg-cover bg-center ' style={{ backgroundImage:`url(${whyimg})`}}> 
      <div data-aos="zoom-in" className='flex flex-col justify-center items-center gap-10 bg-white p-10 rounded-xl md:w-[40%] w-full'>
        ...
        <div className='flex flex-col justify-center items-center gap-4'>
            ...
            <p className='text-xl text-black font-lg '> FIRDAY 10AM - 8PM </p>
      ...
      <div data-aos="slide-up" data-aos-delay="200" className='md:w-[40%] w-full flex flex-col justify-center  gap-6 h-fit'>
            <h1 className='text-6xl text-white justify-center font-bold text-center'>Why Choose Us</h1>
            <p className='text-2xl justify-center font-semibold text-white md:text-start text-center '>WE hired our barber's from abroad , so they are professionals</p>
            <div id='icon-list' className='flex flex-col justify-center items-start gap-4'>
                ...
                <button className='text-black px-10 py-4 bg-white hover:bg-themeyellow hover:text-black rounded-xl font-semibold '>BOOK NOW  </button>
            </div>
          </div>
   </section>
  )
